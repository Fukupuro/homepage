...
tags = ["Ruby", "Rails", "JavaScript", "TypeScript", "React", "Astro", "Docker", "PostgreSQL", "CSS", "Git"].map do |name|
...
blogs_data = [
  {
    ...
    discription: "RailsのAPIモードを活用したAPI開発の基本を解説",
  ...
  },
  {
    ...
    discription: "useState・useReducer・Context APIなどReactの状態管理手法を比較",
    ...
    tag_names: ["React", "JavaScript"]
  },
  {
    title: "Docker Composeで開発環境を統一する",
    discription: "Docker ComposeでRails+PostgreSQL環境を構築する手順",
    ...
    tag_names: ["Docker", "Rails", "PostgreSQL"]
  },
  {
    title: "TypeScriptの型パズルを攻略する",
    discription: "Conditional TypesやTemplate Literal Typesなど高度な型機能を解説",
  ...
  {
    title: "Gitブランチ戦略の選び方",
    discription: "Git Flow・GitHub Flow・Trunk Basedなどブランチ戦略を比較",
  ...
  },
  {
    ...
    discription: "includes・preload・eager_loadの違いとBulletgemの活用法",
    ...
    tag_names: ["Ruby", "Rails", "PostgreSQL"]
  },
  {
    title: "React Server Componentsの実践",
    discription: "サーバーとクライアントのレンダリングを最適に組み合わせる方法",
  ...
  },
  {
    ...
    discription: "マルチステージビルドで本番用イメージサイズを大幅削減",
  ...
  },
  {
    ...
    discription: "Ruby 3系のパターンマッチングで条件分岐を読みやすく改善",
  ...
  },
  {
    ...
    discription: "SQLi・XSS・CSRFなどRails開発のセキュリティ対策まとめ",
  ...
  },
  {
    ...
    discription: "Promise・async/await・イベントループの仕組みを図解で解説",
...
blogs_data.each do |data|
  ...
  tag_names.each do |name|
    ...
    BlogTag.find_or_create_by!(blog: blog, tag: tag)
  end
end
